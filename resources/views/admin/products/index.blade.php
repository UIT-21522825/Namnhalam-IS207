...
<div class="card">
    ...
    <div class="d-flex justify-content-between align-items-center">
        ...
        {{-- @endcan --}}
        <div class="col-lg-6 col-2 text-left position-relative mt-3">
            <form id="searchForm">
                <div class="input-group"> 
                    <input type="text" name="q" class="form-control search" placeholder="Tìm kiếm sản phẩm" style="padding-left: 10px;">
    ...
    <div>
        <table class="table table-hover">
            ...
            @php
            $totalItems = $products->total(); // Tổng số sản phẩm
            $currentPage = $products->currentPage(); // Số trang hiện tại
            $perPage = $products->perPage(); // Số sản phẩm trên mỗi trang
